...
const list = [
    ...
    { 
        ...
        "methods": [{ "method": "read", "params": [{ "name": "dataframeName", "value": "phis_imagenanalysesangle_aggregated_by_day", "type": "value" }] }, 
                ...
                "params": [
                    { "name": "colPartition", "value": "plantURI", "type": "value" }, 
                    { "name": "colOrderBy", "value": "dayOfYear", "type": "value" }, 
                    { "name": "nDays", "value": "30", "type": "value" }, 
                    { "name": "groupSizeDays", "value": "15", "type": "value" }] 
                },

                { "method": "drop", "params": [{ "name": "cols", "value": "1_avg(Silk_area),2_avg(Silk_area)", "type": "list" }] }, 
            ] 
    }
]
